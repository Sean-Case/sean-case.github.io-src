...
model.o.df$tch_prop_2012 = ifelse(model.o.df$tch_prop_2012 > 1,1,model.o.df$tch_prop_2012)
...
model.o.df$density_levels = with(model.o.df, ifelse(muni.dense < 50, "< Fifty", 1))
model.o.df$density_levels = with(model.o.df, ifelse(muni.dense >= 50, "Fifty - two hundred", model.o.df$density_levels))
